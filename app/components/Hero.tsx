    ...
    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      >
        ...
        <ul className="mt-6 text-base leading-8 text-gray-300 sm:text-lg">
          ...
          <li>
            🧿 Detailed information on Compressed NFTs, ProgrammableNFTs,
            Inscriptions, and Token Extensions (Token2022).
          </li>
          <li>
            🧿 Retrieval and display of token data such as token supply and token
            prices for fungible tokens.
          </li>
        </ul>
